...
- [x] Friendly Tkinter desktop app — guided UI for selecting an image, entering a API key (pre-filled from the environment), running detection, and opening an annotated preview.
- [x] Vision integration — uses configurable vision models to locate rats in still images. Model name and minimum confidence are adjustable in the UI.
